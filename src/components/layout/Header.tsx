      ...
      <div className="container mx-auto px-4 max-w-7xl flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 sm:gap-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="relative flex items-center h-9 p-1 rounded-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-all duration-500 hover:ring-4 hover:ring-blue-500/10 group overflow-hidden max-w-[40px] hover:max-w-[100px]"
            >
              <div className={`flex items-center justify-center size-7 rounded-full shadow-md transition-all duration-500 ${theme === 'dark' ? 'translate-x-[calc(100%-0px)] bg-gray-700 text-yellow-300 rotate-[360deg]' : 'translate-x-0 bg-white text-orange-500'}`}>
                {theme === 'light' ? (
              ...
              <span className={`text-[10px] font-black uppercase tracking-widest pr-3 pl-1 opacity-0 group-hover:opacity-100 transition-all duration-500 whitespace-nowrap hidden sm:block ${theme === 'dark' ? '-translate-x-7' : ''}`}>
