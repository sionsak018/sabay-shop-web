...
export const BodyTypePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    } else if (editingBodyType && !imagePreview && editingBodyType.image_url) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button onClick={() => handleOpenModal()} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-bold text-sm flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20 transition active:scale-95 whitespace-nowrap">
