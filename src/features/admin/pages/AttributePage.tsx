                            ...
                            <div className="relative group size-12 flex-shrink-0">
                                { (opt.image || opt.image_url) && (
                                    <button
                                        ...
                                        className="absolute -top-1 -right-1 z-10 size-5 bg-red-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-red-600 transition-colors border-2 border-white dark:border-gray-900 scale-0 group-hover:scale-100 transition-transform"
                                    >
