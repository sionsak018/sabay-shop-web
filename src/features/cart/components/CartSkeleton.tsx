  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 antialiased text-left font-sans animate-pulse">
      ...
      <div className="space-y-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex flex-col sm:flex-row gap-6 bg-white border border-gray-100 p-6 rounded-2xl shadow-sm">
            <div className="w-full sm:w-32 h-32 rounded-xl bg-gray-200 shrink-0" />
      ...
      <div className="mt-12 bg-white border border-gray-100 p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-center justify-between gap-8">
        <div>
            <div className="h-3 bg-gray-100 rounded w-32 mb-2 mx-auto md:mx-0" />
            <div className="h-10 bg-gray-200 rounded w-56" />
        </div>
        <div className="w-full md:w-auto min-w-[280px] h-16 bg-gray-200 rounded-2xl" />
      </div>
    </div>
  );
};
