...
export const EditProductPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#08060d] pb-20 antialiased text-left font-sans transition-colors duration-300">
      <div className="bg-white dark:bg-[#16171d] border-b border-gray-200 dark:border-gray-800 py-4 sm:py-6 mb-8 sticky top-14 z-30 shadow-sm transition-colors">
        <div className="container mx-auto px-4 max-w-5xl flex items-center gap-3 sm:gap-4">
          <button onClick={() => navigate(-1)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
          ...
          <h1 className="text-xl sm:text-2xl font-black text-gray-800 dark:text-gray-100 uppercase tracking-tight">Edit Your Ad</h1>
        </div>
      </div>

      <div className="container mx-auto px-4 max-w-5xl">
        <form onSubmit={handleSubmit} noValidate className="space-y-8 animate-in fade-in duration-500">
          {error && <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 text-red-600 dark:text-red-500 px-6 py-4 rounded-xl text-sm font-bold shadow-sm">{error}</div>}

          {/* Photos */}
          <div className={`bg-white dark:bg-[#16171d] border rounded-2xl shadow-sm overflow-hidden transition-colors ${errors.images ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}>
            <div className="bg-gray-50 dark:bg-gray-800/50 px-4 sm:px-8 py-3 sm:py-5 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
              <h2 className="text-sm font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">Ad Photos</h2>
              <span className="text-xs font-black text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 px-2.5 py-1 rounded-full">{images.length + existingImages.length}/10</span>
            </div>
            <div className="p-4 sm:p-8">
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
                ...
                {previews.map((src, idx) => (
                  <div key={`new-${idx}`} className="relative aspect-square rounded-xl overflow-hidden border-2 border-blue-100 dark:border-blue-900 group shadow-sm">
                ...
                {images.length + existingImages.length < 10 && (
                  <label className={`aspect-square flex flex-col items-center justify-center border-2 border-dashed rounded-xl cursor-pointer transition-all ${errors.images ? 'border-red-300 bg-red-50/30 dark:bg-red-900/10 text-red-400' : 'border-gray-200 dark:border-gray-800 text-gray-400 dark:text-gray-500 hover:border-blue-400 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/10 hover:text-blue-600 dark:hover:text-blue-400 bg-gray-50/50 dark:bg-gray-800/50'}`}>
          ...
          {(dynamicAttributes.length > 0 || (formData.category_id)) && (
            <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden transition-colors">
              <div className="bg-gray-50 dark:bg-gray-800/50 px-4 sm:px-8 py-3 sm:py-5 border-b border-gray-100 dark:border-gray-800">
                <h2 className="text-sm font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">Item Specifications</h2>
              </div>
              <div className="p-4 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 sm:gap-y-8">
                {/* Condition Field - Fixed */}
                <div>
                  <label className="block text-[11px] font-black text-gray-500 dark:text-gray-400 uppercase mb-3 tracking-widest">Condition <span className="text-red-500">*</span></label>
                  <div className={`flex p-1 bg-gray-100 dark:bg-gray-800 rounded-xl gap-1 border transition-colors ${errors.condition ? 'border-red-300' : 'border-transparent dark:border-gray-700'}`}>
                    {['New', 'Used'].map(c => (
                      <button
                          key={c}
                          type="button"
                          ...
                          className={`flex-1 py-3 rounded-lg font-black text-[10px] uppercase tracking-widest transition-all ${formData.condition === c.toLowerCase() ? 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}
                      >
                        {c}
                      </button>
                    ))}
                ...
                {dynamicAttributes.map(attr => (
                  <div key={attr.id}>
                    <label className="block text-[11px] font-black text-gray-500 dark:text-gray-400 uppercase mb-3 tracking-widest">
                    ...
                    {attr.type === 'select' ? (
                      <select
                        ...
                        className={`w-full px-5 py-3.5 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 shadow-inner ${errors[`attr_${attr.id}`] ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                      >
          ...
          <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden transition-colors">
            <div className="bg-gray-50 dark:bg-gray-800/50 px-4 sm:px-8 py-3 sm:py-5 border-b border-gray-100 dark:border-gray-800">
              <h2 className="text-sm font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">General Information</h2>
            </div>
            <div className="p-4 sm:p-8 space-y-6 sm:space-y-8">
              <div>
                <label className="block text-[11px] font-black text-gray-500 dark:text-gray-400 uppercase mb-3 tracking-widest">Ad Title <span className="text-red-500">*</span></label>
                <input
                  type="text"
                  ...
                  className={`w-full px-5 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 ${errors.title ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                />
                {errors.title && <p className="text-red-500 text-[10px] font-bold mt-2 ml-1">{errors.title}</p>}
              </div>

              <div>
                <label className="block text-[11px] font-black text-gray-500 dark:text-gray-400 uppercase mb-3 tracking-widest">Price ($) <span className="text-red-500">*</span></label>
                <div className="relative">
                  <span className={`absolute left-5 top-1/2 -translate-y-1/2 font-black text-lg ${errors.price ? 'text-red-300' : 'text-gray-400 dark:text-gray-600'}`}>$</span>
                  <input
                    type="number"
                    placeholder="0.00"
                    ...
                    className={`w-full pl-10 pr-5 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-black text-gray-800 dark:text-gray-100 text-lg shadow-inner ${errors.price ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                  />
                </div>
              ...
              <div>
                <label className="block text-[11px] font-black text-gray-500 dark:text-gray-400 uppercase mb-3 tracking-widest">Description <span className="text-red-500">*</span></label>
                <div className={`border rounded-xl overflow-hidden shadow-inner ${errors.description ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}>
                  <Editor
                    ref={editorRef}
          ...
          <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden transition-colors">
                <div className="bg-gray-50 dark:bg-gray-800/50 px-4 sm:px-8 py-3 sm:py-5 border-b border-gray-100 dark:border-gray-800">
                    <h2 className="text-sm font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">Item Location</h2>
                </div>
                <div className="p-4 sm:p-8 space-y-6 sm:space-y-8">

                    <div>
                        <label className="block text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase mb-3 tracking-widest ml-1">Select Location <span className="text-red-500">*</span></label>
                        <button
                            type="button"
                            onClick={() => setIsLocationModalOpen(true)}
                            className={`w-full flex items-center justify-between px-6 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-2xl hover:border-blue-500 dark:hover:border-blue-400 transition-all text-left group shadow-inner ${errors.province_id || errors.district_id ? 'border-red-300' : 'border-gray-100 dark:border-gray-800'}`}
                        >
                            {formData.province_id ? (
                                <div className="flex flex-col">
                                    <span className={`text-[10px] font-black uppercase tracking-widest mb-0.5 ${errors.province_id || errors.district_id ? 'text-red-500' : 'text-blue-600 dark:text-blue-400'}`}>Current Selection</span>
                                ...
                                <span className="text-sm font-bold text-gray-400 dark:text-gray-600">Tap to choose province, district, commune...</span>
                            )}
                    ...
                    <div>
                        <label className="block text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase mb-3 tracking-widest ml-1">Detail Address <span className="text-red-500">*</span></label>
                        <input
                            type="text"
                            ...
                            className={`w-full px-5 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 shadow-inner ${errors.address ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                        />
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-white/40 dark:bg-black/40 backdrop-blur-[1px] group-hover:bg-white/5 transition-all">
                                ...
                                <span className="text-[10px] font-black text-gray-700 dark:text-gray-200 bg-white/95 dark:bg-gray-900/95 px-4 py-1.5 rounded-full uppercase tracking-widest shadow-md">
            ...
            <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden transition-colors">
                <div className="bg-gray-50 dark:bg-gray-800/50 px-4 sm:px-8 py-3 sm:py-5 border-b border-gray-100 dark:border-gray-800">
                    <h2 className="text-sm font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest">Contact Information</h2>
                </div>
                <div className="p-4 sm:p-8 space-y-6 sm:space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label className="block text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase mb-3 tracking-widest">Poster Name <span className="text-red-500">*</span></label>
                            <input
                              type="text"
                              ...
                              className={`w-full px-5 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 shadow-inner ${errors.poster_name ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                            />
                            {errors.poster_name && <p className="text-red-500 text-[10px] font-bold mt-2 ml-1">{errors.poster_name}</p>}
                        </div>
                        <div>
                            <label className="block text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase mb-3 tracking-widest">Email Address <span className="text-red-500">*</span></label>
                            <input
                                type="email"
                                ...
                                className={`w-full px-5 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 shadow-inner ${errors.poster_email ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                            />
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-3">
                            <label className="block text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Contact Numbers <span className="text-red-500">*</span></label>
                            {phones.length < 3 && (
                                <button
                                    type="button"
                                    onClick={addPhone}
                                    className="text-[10px] font-black text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 uppercase tracking-widest flex items-center gap-1 transition-colors"
                                >
                                ...
                                <div key={idx} className="flex gap-2">
                                    <div className="relative flex-grow">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-2 border-r border-gray-200 dark:border-gray-800 pr-3">
                                            ...
                                            <span className={`text-[10px] font-black uppercase tracking-tighter ${idx === 0 && errors.phone ? 'text-red-400' : 'text-gray-400 dark:text-gray-600'}`}>{idx + 1}</span>
                                        </div>
                                        <input
                                            type="tel"
                                            ...
                                            className={`w-full pl-16 pr-4 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 shadow-inner ${idx === 0 && errors.phone ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                                        />
                                    </div>
                                    {phones.length > 1 && (
                                        <button
                                            ...
                                            className="p-4 text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 transition-colors"
                                        >
                    ...
                    <div>
                        <label className="block text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase mb-3 tracking-widest ml-1">Business/Company Name <span className="text-red-500">*</span></label>
                        <input
                            type="text"
                            ...
                            className={`w-full px-5 py-4 bg-gray-50 dark:bg-[#08060d] border rounded-xl focus:bg-white dark:focus:bg-[#16171d] focus:border-blue-500 dark:focus:border-blue-400 outline-none transition font-bold text-gray-800 dark:text-gray-200 shadow-inner ${errors.company_name ? 'border-red-300' : 'border-gray-200 dark:border-gray-800'}`}
                        />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-8 pt-6">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full sm:w-auto sm:min-w-[300px] bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-xl font-black uppercase tracking-[0.2em] transition-all shadow-2xl shadow-blue-600/30 active:scale-95 disabled:opacity-50"
            >
