...
export const ProductSkeleton = ({ variant = 'grid' }: ProductSkeletonProps) => {
  if (variant === 'list') {
    return (
      <div className="bg-white border border-gray-100 rounded-lg p-2 sm:p-3 flex gap-3 sm:gap-4 animate-pulse">
        <div className="w-32 sm:w-48 aspect-[4/3] bg-gray-200 rounded-md shrink-0" />
  ...
  return (
    <div className="bg-white border border-gray-200 rounded sm:rounded-md overflow-hidden flex flex-col h-full animate-pulse">
