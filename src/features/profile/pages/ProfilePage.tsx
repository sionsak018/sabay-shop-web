...
export const ProfilePage = () => {
  ...
  return (
    <div className="bg-[#f1f2f6] dark:bg-[#08060d] min-h-screen antialiased pb-20 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 max-w-6xl relative">
          <div className="flex flex-col md:flex-row items-center md:items-center gap-5 -mt-10 pb-6">
            ...
            <div className="flex-1 text-center md:text-left pt-6 md:pt-10">
              ...
              <p className="text-gray-500 dark:text-gray-400 font-medium text-xs mb-4 max-w-2xl leading-relaxed">
            ...
            <div className="flex gap-4 sm:gap-6 pb-2 pt-6 md:pt-10">
                ...
                <button onClick={() => handleTabChange('followers')} className="text-center group">
                    <p className="text-xl font-black text-gray-900 dark:text-gray-100 leading-none group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{stats.followers_count}</p>
                ...
                <button onClick={() => handleTabChange('following')} className="text-center group">
                    <p className="text-xl font-black text-gray-900 dark:text-gray-100 leading-none group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{stats.following_count}</p>
      ...
      <div className="container mx-auto px-4 max-w-6xl py-6">
        <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="p-2 flex lg:flex-col gap-0.5 whitespace-nowrap">
                {[
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-2.5 text-[13px] font-bold flex items-center gap-3 transition-all rounded-lg ${activeTab === item.id ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-blue-600 dark:hover:text-blue-400'}`}
                  >
                    {item.icon}
                    {item.label}
                  </button>
          ...
          <div className="flex-1 space-y-6 min-w-0">
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-400">
                ...
                {limitInfo?.limit_reached && (
                    <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 p-6 rounded-2xl flex flex-col md:flex-row items-center gap-6 shadow-sm">
                        <div className="w-12 h-12 bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center text-red-600 dark:text-red-500 shrink-0">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                        </div>
                        <div className="flex-1 text-center md:text-left">
                            <h3 className="font-black text-red-900 dark:text-red-400 text-sm uppercase tracking-tight mb-1">Ad Limit Reached</h3>
                            <p className="text-red-700 dark:text-red-500 text-xs font-bold">You have used all your active ad slots ({limitInfo.active_count}/{limitInfo.post_limit}).</p>
                            <p className="text-red-600/70 dark:text-red-400/70 text-[10px] mt-2 leading-relaxed">Delete old items or upgrade to <b>Store Member</b> for unlimited postings.</p>
                        </div>
                        <a
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    { label: 'Active Ads', val: limitInfo?.active_count || 0, icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-900/20' },
                    { label: 'Saved Items', val: savedProducts.length, icon: 'M4.318 6.318a4.5 4.01 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.01 0 00-6.364 0z', color: 'text-rose-500 dark:text-rose-400', bg: 'bg-rose-50 dark:bg-rose-900/20' },
                    { label: 'Posting Limit', val: `${limitInfo?.active_count || 0}/${limitInfo?.post_limit || 0}`, icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', color: 'text-amber-500 dark:text-amber-400', bg: 'bg-amber-50 dark:bg-amber-900/20' },
                  ].map((stat, i) => (
                    <div key={i} className="bg-white dark:bg-[#16171d] p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-center gap-4 hover:border-blue-200 dark:hover:border-blue-800 transition-colors">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-black text-gray-800 dark:text-gray-100">{stat.val}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* About Section */}
                    <div className="lg:col-span-1 bg-white dark:bg-[#16171d] rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">My Bio</h2>
                            <button onClick={() => handleTabChange('settings')} className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition">
                    ...
                    {/* Recent Ads Section */}
                    <div className="lg:col-span-2 bg-white dark:bg-[#16171d] rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
                            <h2 className="text-[11px] font-black text-gray-800 dark:text-gray-200 uppercase tracking-widest">Recently Posted</h2>
                            <button onClick={() => handleTabChange('ads')} className="text-blue-600 dark:text-blue-400 text-[9px] font-black uppercase hover:underline">View All My Ads</button>
                        </div>
                        <div className="p-4 grid grid-cols-2 gap-4">
                            {productsLoading ? (
                                [...Array(2)].map((_, i) => (
                                    <div key={i} className="aspect-[4/3] bg-gray-50 dark:bg-gray-800 rounded-lg animate-pulse border border-gray-100 dark:border-gray-800" />
                                ))
                            ) : (
                                <>
            ...
            {activeTab === 'ads' && (
              <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm overflow-hidden min-h-[500px] animate-in fade-in duration-300">
                <div className="bg-gray-50/80 dark:bg-gray-800/80 px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center sticky top-0 z-10 backdrop-blur-md transition-colors">
                  <h2 className="text-[11px] font-black text-gray-800 dark:text-gray-200 uppercase tracking-widest">My Marketplace Listings</h2>
                  {limitInfo && (
                ...
                {limitInfo?.limit_reached && (
                    <div className="bg-red-50 dark:bg-red-900/10 p-4 border-b border-red-100 dark:border-red-900/30 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-xs font-bold text-red-700 dark:text-red-400">Limit reached! Upgrade for unlimited listings.</p>
                        </div>
                        <a href="https://t.me/Sion_Sak" target="_blank" rel="noreferrer" className="text-[10px] font-black text-red-600 dark:text-red-400 hover:underline uppercase tracking-widest">Upgrade Now</a>
                    </div>
                )}
                <div className="divide-y divide-gray-100 dark:divide-gray-800">
                  {userProducts.map(p => (
                    <div key={p.id} className="p-4 md:p-5 flex flex-col sm:flex-row gap-4 items-center hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors group">
                       ...
                       <div className="flex-1 min-w-0 text-center sm:text-left">
                          <p className="font-bold text-gray-900 dark:text-gray-100 text-[13.5px] mb-1 line-clamp-2 leading-tight">{p.title}</p>
                          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-1">
                            <p className="text-blue-600 dark:text-blue-400 font-black text-sm">${Number(p.price).toLocaleString()}</p>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase">{p.category?.name}</span>
                                <div className="w-1 h-1 bg-gray-300 dark:bg-gray-700 rounded-full" />
                                <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium tracking-tighter">ID: #{p.id}</span>
                            </div>
                            <span className={`text-[8px] font-black uppercase px-2 py-0.5 rounded border ${
                              p.status === 'active' ? 'bg-green-50 dark:bg-green-900/10 text-green-600 dark:text-green-400 border-green-100 dark:border-green-900/30' :
                              p.status === 'sold' ? 'bg-orange-50 dark:bg-orange-900/10 text-orange-600 dark:text-orange-400 border-orange-100 dark:border-orange-900/30' : 'bg-gray-50 dark:bg-gray-800 text-gray-400 dark:text-gray-500 border-gray-200 dark:border-gray-700'
                            }`}>
                              {p.status}
                            </span>
                          </div>
                       ...
                       <div className="flex items-center gap-1.5 flex-wrap justify-center sm:flex-nowrap">
                         {p.status === 'active' ? (
                           <div className="flex gap-1">
                             <button
                               ...
                               className="px-4 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-md text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 dark:hover:bg-blue-600 transition shadow-sm flex items-center gap-1.5"
                             >
                             ...
                             <button
                               ...
                               className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-md text-[10px] font-black uppercase tracking-widest hover:bg-gray-200 dark:hover:bg-gray-700 transition flex items-center gap-1.5"
                             >
                           ...
                           <button
                             ...
                             className="px-6 py-2 bg-green-600 dark:bg-green-500 text-white rounded-md text-[10px] font-black uppercase tracking-widest hover:bg-green-700 dark:hover:bg-green-600 transition shadow-sm flex items-center gap-1.5 disabled:opacity-30"
                         ...
                         <div className="w-px h-8 bg-gray-100 dark:bg-gray-800 mx-1 hidden sm:block" />

                         <div className="flex gap-1">
                            <Link
                                to={`/edit-product/${p.id}`}
                                className="p-2.5 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/10 rounded-md transition border border-gray-100 dark:border-gray-800 hover:border-blue-100 dark:hover:border-blue-900/30"
                            >
                            ...
                            <button
                                ...
                                className="p-2.5 text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/10 rounded-md transition border border-gray-100 dark:border-gray-800 hover:border-red-100 dark:hover:border-red-900/30"
                            >
                  ...
                  {userProducts.length === 0 && (
                    <div className="p-24 text-center flex flex-col items-center gap-4 animate-in zoom-in-95 duration-500">
                        <div className="w-20 h-20 bg-gray-50 dark:bg-gray-800/50 rounded-full flex items-center justify-center text-gray-200 dark:text-gray-700">
            ...
            {activeTab === 'saved' && (
              <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm overflow-hidden min-h-[500px] animate-in fade-in duration-300">
                <div className="bg-gray-50/80 dark:bg-gray-800/80 px-6 py-4 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-10 backdrop-blur-md transition-colors">
                    <h2 className="text-[11px] font-black text-gray-800 dark:text-gray-200 uppercase tracking-widest">Wishlist Items</h2>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-5">
                  ...
                  {savedProducts.length === 0 && (
                    <div className="col-span-full p-24 text-center flex flex-col items-center">
                        <div className="w-20 h-20 bg-rose-50 dark:bg-rose-900/10 rounded-full flex items-center justify-center text-rose-200 dark:text-rose-900/40 mb-4">
                        ...
                        <p className="text-gray-900 dark:text-gray-100 font-black uppercase text-sm tracking-tight mb-1">Heart something you love</p>
                        <p className="text-gray-400 dark:text-gray-500 text-xs font-medium mb-6">Your saved items will appear here for easy access.</p>
                        <Link to="/" className="text-blue-600 dark:text-blue-400 font-black text-[11px] uppercase tracking-widest border-b-2 border-blue-100 dark:border-blue-900/30 hover:border-blue-600 transition-all pb-0.5">Explore Marketplace</Link>
                    </div>
                  )}
                </div>
              </div>
            ...
            {(activeTab === 'followers' || activeTab === 'following') && (
              <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm overflow-hidden min-h-[500px] animate-in fade-in duration-300">
                <div className="bg-gray-50/80 dark:bg-gray-800/80 px-6 py-4 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-10 backdrop-blur-md transition-colors">
                    <h2 className="text-[11px] font-black text-gray-800 dark:text-gray-200 uppercase tracking-widest">{activeTab}</h2>
                </div>
              ...
              <div className="bg-white dark:bg-[#16171d] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden animate-in fade-in slide-in-from-right-4 duration-400">
                ...
                <div className="p-4 sm:p-8 space-y-6 sm:space-y-8 max-w-2xl">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                      <label className="block text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest ml-1">Contact Phone Number</label>
                      <input
                        value={phone}
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        rows={5}
                        className="w-full px-4 py-3 bg-gray-50 dark:bg-[#08060d] border border-gray-200 dark:border-gray-800 rounded-xl outline-none focus:bg-white dark:focus:bg-[#1f2028] focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-500/5 font-medium text-[13px] transition-all resize-none text-gray-800 dark:text-gray-200"
                  ...
                  <div className="pt-4 border-t border-gray-50 dark:border-gray-800">
                    <button
                        ...
                        disabled={loading}
                        className="group bg-blue-600 dark:bg-blue-500 text-white px-12 py-3.5 rounded-xl font-black text-[11px] uppercase tracking-widest transition-all shadow-xl shadow-blue-600/20 hover:shadow-blue-600/40 hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-3"
                    >
                        {loading ? (
